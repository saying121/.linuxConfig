...
cp ~/.linuxConfig/polybar/hack-modules.ini ~/.config/polybar/hack/modules.ini
cp ~/.linuxConfig/polybar/hack-user_modules.ini ~/.config/polybar/hack/hack-user_modules.ini
cp ~/.linuxConfig/polybar/hack-config.ini ~/.config/polybar/hack/hack-config.ini
