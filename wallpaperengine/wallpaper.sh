...
cd ~/Downloads/linux-wallpaperengine/share
...
while :; do
    ...
    nohup ~/Downloads/linux-wallpaperengine/build/linux-wallpaperengine --silent --assets-dir $assets --screen-root $screen $id 2>&1 >/tmp/wallpaper.log
    sleep $((60 * 40))
